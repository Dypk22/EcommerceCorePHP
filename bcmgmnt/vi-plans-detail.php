<?php 
   ...
   $ViActive="yes";
   require 'header.php'; 
   $operator_details=mysqli_fetch_assoc(mysqli_query($con,'select * from vi_plan where id="'.$_GET['id'].'"'));
   if (isset($_POST['UpdatePlanBtn'])) {
      ...
      mysqli_query($con, "UPDATE `vi_plan` SET `status` = '$status',`type` = '$type',`amount` = '$amount',`data` = '$data',`validity` = '$validity',`description` = '$description' WHERE `vi_plan`.`id` = '".$_GET['id']."'");
      header('Location:'.ADMIN_SITE_PATH.'vi-plans');
   }
   ?>
<main>
               ...
               <div class="card-body-table">
                  <div class="shopowner-content-left text-center pd-20">
                     <div class="customer_img">
                        <img src="../images/brands/operator/vi.png" alt="">
                     </div>
                     <div class="shopowner-dt-left mt-4 mb-30">
                        <h4 class="text-capitalize">VI</h4>
