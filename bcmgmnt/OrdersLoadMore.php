<?php  
  ...
  $sql = "SELECT * FROM mobile_recharge_orders WHERE id < ".$_POST['last_video_id']." order by id desc LIMIT ".per_row_records;  
  ...
  {  
       ...
       {  
          ...
          $output .= ' 
            <tr>
               <td class="text-center"><small class="rupeeIcon">#</small>'.$row['transaction_id'].'</td>
       ...
       <tr id="LoadMoreBtnRow">
          <td></td>
          <td></td>
          <td class="text-center"><button class="save-btn hover-btn mx-auto my-2" data-vid="'. $video_id .'" id="OrdersLoadMore" type="button">Load More</button></td>
          <td></td>
          <td></td>
        </tr>
       ';  
